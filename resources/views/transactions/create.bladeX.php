    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Add Transction</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
...
<section class="content">
  <div class="container-fluid">
    <form method="post" action="{{ route('storetransactions') }}" value="saveorder">
  ...
  <div class="row">
      <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <button id="add_row" value="addrow" class="btn btn-default pull-left">+ Add Row</button>
                    <button id='delete_row' value="deleterow" class="pull-right btn btn-danger">- Delete Row</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="row">
          <label class="col-md-3">Delivery Location Detail</label>
          <div><textarea name="deliverylocation" cols="100" rows="10"> </textarea></div>
      ...
      <div class="form-group">
        <input id="saveForm" type="submit" class="btn btn-info" value="Save">
    
        <input id="cancelForm" class="btn btn-danger" type="reset" value="Cancel">
    </div>
    ...
    $("#add_row").click(
      function(e)
      {
        ...
        b=i-1;
      	...
      	$('#products_table').append('<tr id="addr'+(i+1)+'"></tr>');
      	i++; 
